		...
		<form id="categoryForm" class="am-form">
			...
			<div class="am-u-sm-12 am-u-sm-centered">
				...
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-8 am-u-md-6">
						<input type="text" name="category.url" value="${category.url}" class="am-input-sm">
					</div>
				...
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-8 am-u-md-6">
						<input type="text" name="category.render" value="${category.render}" class="am-input-sm">
					</div>
					<div class="am-hide-sm-only am-u-md-4">*必填</div>
				</div>
				...
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-8 am-u-md-6">
						<input type="text" name="category.sort" value="${category.sort}"
							class="am-input-sm">
					</div>
				...
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-8 am-u-md-6">
						<textarea rows="3" name="category.remark">${category.remark}</textarea>
					</div>
					<div class="am-hide-sm-only am-u-md-4">选填</div>
				</div>
				...
				<div class="am-u-sm-10 am-u-sm-push-2">
					<button type="button" onclick="saveCategory();" class="am-btn am-btn-primary am-btn-xs">保存修改</button>
