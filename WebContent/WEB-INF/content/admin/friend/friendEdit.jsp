			...
			<div class="am-u-sm-12 am-u-sm-centered">
				...
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-8 am-u-md-6">
						<input type="text" name="friend.name" class="am-input-sm" value="${friend.name}" />
					</div>
				...
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-8 am-u-md-6">
						<input type="text" name="friend.url" class="am-input-sm" value="${friend.url}" />
					</div>
				...
				<div class="am-u-sm-10 am-u-sm-push-2">
					<button type="button" onclick="saveFriend();" class="am-btn am-btn-primary am-btn-xs">保存修改</button>
...
<script type="text/javascript">
    ...
    $("#visible").val("${friend.visible}");
    
	function saveFriend() {
		var loader = layer.load();
		$.ajax({
			type : "POST",
			url : "${base}/admin/saveFriend",
