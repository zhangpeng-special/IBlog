    ...
    <div class="am-tabs-bd">
      ...
      <div class="am-u-sm-12 am-u-md-8">
        ...
        <div class="am-g am-margin-top">
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-6">
              <input type="text" name="blog.title" value="${blog.title}" class="am-input-sm">
            </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-6 am-u-end col-end">
              <input type="text" name="blog.sourceName" value="${blog.sourceName}" class="am-input-sm">
            </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-6">
              <input type="text" name="blog.tags" value="${blog.tags}" class="am-input-sm">
            </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-6">
              <input type="text" name="blog.sourceURL" value="${blog.sourceURL}" class="am-input-sm">
            </div>
            <div class="am-hide-sm-only am-u-md-4">选填</div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-6">
              <textarea rows="4" name="blog.statement">${blog.statement}</textarea>
            </div>
        ...
        <div class="am-panel am-panel-default">
          <div class="am-panel-bd">
            <div class="am-g">
              <div class="am-u-md-4">
                <img id="imgShow" class="am-img-circle am-img-thumbnail" src="${blog.titlePicture}" alt=""/>
              </div>
              <div class="am-u-md-8">
                <p>主人，别忘了选一张图片作为这篇文章的logo哦</p>
                  <div class="am-form-group">
                    <input type="hidden" id="titlePicture" name="blog.titlePicture" value="${blog.titlePicture}" />
      ...
      <div class="am-tab-panel am-fade" id="tab2">
         <div class="am-u-sm-12 am-u-sm-centered">
           <script id="editor" name="blog.content" type="text/plain" style="height:500px;">
           ${blog.content}
           </script>
         </div>
      </div>
